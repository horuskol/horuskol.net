...
<html lang="en">
    ...
    <body class="max-w-lg border-t-6 ml-auto mr-auto border-indigo bg-grey-lightest text-black">
        <header class="pb-4">
            <h1 class="mt-4 ml-10"><a href="/" class="no-underline text-black hover:bg-grey">HorusKol</a></h1>
            <h2 class="mt-4 ml-10 mr-25pc">Adventures and musings in the world of web development</h2>
        </header>

        <div style="border-radius: 2rem 100% 0% 0% / 100% 100% 0% 0%;" class="h-8 min-h-0 ml-3 mr-3 pt-2 pb-2 bg-indigo-lighter">
            <nav>
                <ul>
                    <li class="inline-block"><a href="/posts" class="text-grey-darkest">Blog</a></li>
                </ul>
            </nav>
        </div>
        ...
        <div style="border-radius: 0% 0% 2rem 100% / 0% 0% 100% 100%;" class="h-8 ml-3 mr-3 bg-indigo-lighter"></div>
